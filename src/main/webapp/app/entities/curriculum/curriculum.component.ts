...
export class CurriculumComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.curriculumService
      ...
      .subscribe(
        (res: HttpResponse<ICurriculum[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICurriculum[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
