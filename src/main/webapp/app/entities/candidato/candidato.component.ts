...
export class CandidatoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.candidatoService
      ...
      .subscribe(
        (res: HttpResponse<ICandidato[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICandidato[] | null, headers: HttpHeaders, page: number): void {
