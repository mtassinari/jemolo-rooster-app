  ...
  imports: [
    RouterModule.forChild([
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./stato-registrazione/stato-registrazione.module').then(m => m.JemoloRoosterAppStatoRegistrazioneModule),
      },
      {
        path: 'competenze-lng',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./dichiarazioni-obligatorie/dichiarazioni-obligatorie.module').then(
            m => m.JemoloRoosterAppDichiarazioniObligatorieModule
          ),
      },
      {
        path: 'dichiarazioni',
