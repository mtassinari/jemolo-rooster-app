...
export class CompetenzeLngComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.competenzeLngService
      ...
      .subscribe(
        (res: HttpResponse<ICompetenzeLng[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICompetenzeLng[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
