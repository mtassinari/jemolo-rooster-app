...
import { CurriculumComponent } from 'app/entities/curriculum/curriculum.component';
...
describe('Component Tests', () => {
  describe('Curriculum Management Component', () => {
    let comp: CurriculumComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CurriculumComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.curricula && comp.curricula[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
