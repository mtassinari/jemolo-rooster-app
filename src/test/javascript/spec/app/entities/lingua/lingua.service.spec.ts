...
describe('Service Tests', () => {
  describe('Lingua Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(LinguaService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Lingua(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Lingua', () => {
        ...
        service.create(new Lingua()).subscribe(resp => (expectedResult = resp.body));
